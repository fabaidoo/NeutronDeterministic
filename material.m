classdef material
    ...
    methods
        ...
        function [psi1, phi0, phi1, phi2, Q_new] = ...
                step_characteristic(obj,Oz, psi0)
            
            %Takes the direction of neutron flow and the incoming angular
            %flux and performs a step characteristics transport sweep to
            %determine the angular flux within material and the 0th to 2nd 
            %angular moments of the angular flux
            Delta = (obj.right - obj.left);
            tau_z = obj.sig_t * Delta / abs(Oz);
        ...
        function [psi1, phi0, phi1, phi2, Q_new] = ...
                diamond_difference(obj,Oz, psi0)
