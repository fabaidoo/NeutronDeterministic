function [phi0, phi1, psi] = step_characteristics(edges, mat, psi_l,...
...
%DO SOURCE UPDATE !!!! Use vector of Qs
        ...
        if Oz(j) > 0 %forward sweep 
            for k = 1: len
                ...
                [phi0_ang(j, k), phi1_ang(j, k), Q, psi(j, k+1)] = ...
                    obj.step_characteristics(Oz(j), psi(j, k), phi0(k),...
                    phi1(k), Q);
             ...
             for k = 1: len
                 ...
                 Q = obj.Q0;
                  [phi0_ang(j, i), phi1_ang(j, i), Q, psi(j, i)] = ...
                      obj.step_characteristics(Oz(j), psi(j, i+1),...
                      phi0(i), phi1(i), Q); 
