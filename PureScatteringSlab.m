...
for k = 1: length(m)
    ...
    semilogx(1 ./n, err0dd{k}, '.--','DisplayName', strdd, 'LineWidth', 2,...
        'Color', color(k, :), 'MarkerSize', 15) 
    hold on
    semilogx( 1 ./ n, err0sc{k}, '-','DisplayName', strsc, 'LineWidth', 2,...
        'Color', color(k, :),'Marker','.', 'MarkerSize', 15)
   
    
    figure(fig1)
    semilogx(1 ./n, err1dd{k}, '.--','DisplayName', strdd, 'LineWidth', 2,...
        'Color', color(k, :), 'MarkerSize', 15) 
    hold on
    semilogx( 1 ./ n, err1sc{k}, '.-', 'DisplayName', strsc, 'LineWidth', 2,...
        'Color', color(k, :), 'MarkerSize', 15)
